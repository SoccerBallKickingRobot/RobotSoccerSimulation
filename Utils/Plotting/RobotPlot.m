...
for i = 1:length(fields)
    plot3([Robot.KinematicChains.(fields{i}).points.o(1,:),...
        Robot.KinematicChains.(fields{i}).points.pG(1,:)],...
        [Robot.KinematicChains.(fields{i}).points.o(2,:),...
        Robot.KinematicChains.(fields{i}).points.pG(2,:)],...
        [Robot.KinematicChains.(fields{i}).points.o(3,:),...
